...
class RoadGraphics(object):
    ...
    @staticmethod
    def display_traffic(road: Road, surface: WorldSurface, policy: str, simulation_frequency: int = 15, offscreen: bool = False) \
            -> None:
        """
        ...
        for v in road.vehicles:
            VehicleGraphics.display(v, surface, policy, offscreen=offscreen)
